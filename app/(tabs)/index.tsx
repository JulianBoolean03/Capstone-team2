...
const DEMO_CONVERSATIONS: Conversation[] = [
  ...
  },
  {
    ...
    lastMessage: {
      id: 'msg-2',
      content: 'Thanks for the notes from class!',
      senderId: 'user-2',
  ...
  },
  {
    ...
    lastMessage: {
      id: 'msg-3',
      content: 'Did you finish the homework assignment?',
      senderId: 'user-3',
...
export default function HomeScreen() {
  ...
  const loadConversations = useCallback(async () => {
    try {
      ...
      setConversations(data.conversations.length > 0 ? data.conversations : DEMO_CONVERSATIONS);
    } catch (err) {
      console.error('Failed to load conversations:', err);
      // Show demo conversations on error
      setConversations(DEMO_CONVERSATIONS);
      setError('Using demo chats. Connect to load your real conversations.');
    } finally {
      setLoading(false);
      setRefreshing(false);
    }
